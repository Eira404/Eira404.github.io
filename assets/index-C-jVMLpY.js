...
import{_ as L,a as B,b as O}from"./console.vue_vue_type_style_index_0_lang-B5HnoHtu.js";import{d as R,u as q,_ as A}from"./index-8ww7j3I3.js";import{D as H,au as P,av as F,b as a,d as I,w as k,I as D,J,N as f,F as G,G as Y,P as l,Y as V,Q as p,aw as S,ax as N,af as _,ai as h,a3 as K}from"./vendor-Cgv2NQ8W.js";import"./index.vue_vue_type_script_setup_true_lang-aue9ISe-.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./echarts-CyEgZDPw.js";import"./zrender-BMBjG4B0.js";import"./katex-S9ZM2IJj.js";import"./typescript-CUSX335q.js";const Q={class:"h-full overflow-auto w-full"},W=H({__name:"sandbox",props:P({html:{type:String,required:!0},css:{type:String,required:!0},js:{type:String,required:!0},ts:{type:String,required:!0}},{logs:{required:!0,type:Array},logsModifiers:{}}),emits:["update:logs"],setup(E){const v=E,j=F(E,"logs"),i=a(null),n=I(()=>x(v.html,v.css,v.js,v.ts)),u=a(n.value),w=R(s=>{u.value=s},500),g=T();g(u.value),k(n,s=>{w(s)}),k(u,s=>{g(s)});function T(){let s=null;const r=b=>{s&&clearTimeout(s),s=null,i.value?(j.value=[],i.value.srcdoc=b):s=setTimeout(()=>r(b),100)};return r}function c(s){return s.replace(/<\/script>/gi,"<\/script>")}function x(s,r,b,M){const U=c(b),m=c(M);return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8" />
