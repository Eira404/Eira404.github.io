...
import{_ as L,a as B,b as O}from"./console.vue_vue_type_style_index_0_lang-BTsus7Ju.js";import{d as J,u as q,_ as A}from"./index-xOQeeRiY.js";import{a4 as H,aS as P,aT as F,w as l,z as G,x as V,a7 as N,a8 as R,aa as f,a5 as I,a6 as z,ac as a,al as k,ad as p,aU as S,aV as D,aD as _,aG as h,ar as K}from"./vendor-lsvYFlz-.js";import"./index.vue_vue_type_script_setup_true_lang-DOJkVeVG.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./@codemirror-CRYCp3tI.js";import"./echarts-Cx3wvM_t.js";import"./zrender-DxEpQaPd.js";import"./katex-CYndhgSo.js";import"./@pixi-BVfLF5Lp.js";import"./typescript-BEKa3Ftb.js";const W={class:"h-full overflow-auto w-full"},Y=H({__name:"sandbox",props:P({html:{type:String,required:!0},css:{type:String,required:!0},js:{type:String,required:!0},ts:{type:String,required:!0}},{logs:{required:!0,type:Array},logsModifiers:{}}),emits:["update:logs"],setup(E){const v=E,U=F(E,"logs"),i=l(null),n=G(()=>x(v.html,v.css,v.js,v.ts)),u=l(n.value),w=J(o=>{u.value=o},500),g=T();g(u.value),V(n,o=>{w(o)}),V(u,o=>{g(o)});function T(){let o=null;const r=b=>{o&&clearTimeout(o),o=null,i.value?(U.value=[],i.value.srcdoc=b):o=setTimeout(()=>r(b),100)};return r}function c(o){return o.replace(/<\/script>/gi,"<\/script>")}function x(o,r,b,M){const j=c(b),m=c(M);return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8" />
...
//# sourceMappingURL=index-DSAeinf7.js.map
